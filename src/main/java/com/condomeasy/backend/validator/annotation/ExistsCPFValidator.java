...
import com.condomeasy.backend.validator.CheckExistsCPFValidator;
...
@Constraint(validatedBy = CheckExistsCPFValidator.class)
public @interface ExistsCPFValidator {
