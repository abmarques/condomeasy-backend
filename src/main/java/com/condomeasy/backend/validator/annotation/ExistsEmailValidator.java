...
import com.condomeasy.backend.validator.CheckExistsEmailvalidator;
...
@Constraint(validatedBy = CheckExistsEmailvalidator.class)
public @interface ExistsEmailValidator {
